...
HOME_DESCRIPTION = " Texte à completer "
...
SECTION_1_2_HEATMAP_1_DESCRIPTION = " Ce graphique a comme objectif de dresser le portrait des progressions des niveaux de complétion d'activités par patient "
...
SECTION_2_GROUPED_BAR_HEADER = " Cette section présente la corrélation possible entre les notes prises sur un patient comparée au nombre de chutes et d'hospitalisation \n"
